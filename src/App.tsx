  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_50%_50%,_#101424_0%,_#06070d_100%)] text-white p-4 flex justify-center items-center font-sans">
      <div className="bg-[#0f121c]/70 border border-white/5 backdrop-blur-xl p-8 sm:p-10 rounded-3xl w-full max-w-[440px] shadow-[0_15px_35px_rgba(0,0,0,0.5)] text-center relative z-10">
        ...
        <button 
          onClick={onLogin}
          className="w-full bg-white text-slate-800 border-none rounded-xl p-3 font-semibold text-[0.95rem] flex items-center justify-center gap-3 cursor-pointer transition-all hover:shadow-[0_0_15px_rgba(255,255,255,0.5)] hover:-translate-y-[2px]"
        >
          <img src="https://fonts.gstatic.com/s/i/productlogos/googleg/v6/web-24dp/rpage.img" alt="Google" className="w-5" />
          Entrar com o Google
        </button>
